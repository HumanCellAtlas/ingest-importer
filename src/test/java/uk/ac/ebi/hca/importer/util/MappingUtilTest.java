...
public class MappingUtilTest {
    ...
    @Test
    public void test_with_valid_donor_organism_core_schema() {
    ...
    @Test
    public void test_with_valid_smartseq2_schema() {
        WorksheetMappingSpy worksheetMapping = new WorksheetMappingSpy();
    ...
    @Test
    public void test_with_invalid_schema() {
        WorksheetMappingSpy worksheetMapping = new WorksheetMappingSpy();
    ...
    @Test
    public void test_with_valid_project_schema() {
        WorksheetMappingSpy worksheetMapping = new WorksheetMappingSpy();
